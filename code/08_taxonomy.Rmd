...
ASV overlap (present/absent) among feed, digesta, mucosa and  water samples.

```{r, fig.width=5}
ps %>%
  # remove control samples
  subset_samples(Source %in% c("Digesta", "Mucosa", "Feed", "Water")) %>%
  MicEco::ps_venn(group = "Source", type = "counts")
```
